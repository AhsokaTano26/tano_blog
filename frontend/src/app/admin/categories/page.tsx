      ...
      <div className="glass-card rounded-xl p-5 mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3">
          ...
          <input type="text" placeholder="Slug" value={slug} onChange={e => setSlug(e.target.value)}
            className="px-3 py-2.5 rounded-lg text-sm font-mono outline-none" style={{ border: '1px solid var(--glass-border)', background: 'var(--surface-bg)', color: 'var(--text-primary)' }} />
        ...
        <div className="flex gap-2">
          ...
          {editing && <button onClick={() => { setEditing(null); setName(''); setSlug(''); setDescription(''); }}
