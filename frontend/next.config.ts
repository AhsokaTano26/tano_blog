    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Content-Security-Policy', value: `default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' static.cloudflareinsights.com https://challenges.cloudflare.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self'; connect-src 'self' ${API_UPSTREAM} https://hub.docker.com; frame-src https://challenges.cloudflare.com; object-src 'none'` },
